...
<body>
    ...
    <div class="logout">
        <a href="http://localhost:3000/GitExercise-GroupTT3L-11/GitExercise-GroupTT3L-11/page/uhome.php">Logout</a>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="./endpoint/add-student.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="studentClubs">Clubs :</label>
                            <input type="text" class="form-control" id="studentClubs" name="Clubs">
                        </div>
    ...
    <script>
        ...
        function updateStudent(id) {
            ...
            let updateStudentClubs = $("#studentClubs-" + id).text();

            $("#updateStudentId").val(updateStudentId);
            $("#updateStudentName").val(updateStudentName);
            $("#updateStudentClubs").val(updateStudentClubs);
        }
        ...
        function generateQrCode() {
            ...
            if (text === "") {
                ...
                document.getElementById('studentClubs').style.pointerEvents = 'none';
