...
(4, 2, '2024-05-09 02:28:48'),
(5, 1, '2024-05-09 02:30:20');
...
(1, 'user', 'club', 'KIYkAk6ZRV'),
(2, 'user2', 'club2', 'eJ4xMitwS3');
...
--
ALTER TABLE `tbl_attendance`
  MODIFY `tbl_attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
