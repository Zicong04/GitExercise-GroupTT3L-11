...
<center>
    ...
    <nav> 
        <div>
            ...
            <div class="item"><a href="http://localhost:3000/GitExercise-GroupTT3L-11/GitExercise-GroupTT3L-11/feedback/index.html">Feedback</a>
            <div class="detail"><div class="fonts"><ul>
                <li>Feedback Form</li>
            </ul></div></div>
            </div>
            <div class="item"><a href="announcemnet.php">Announcement</a>
            <div class="detail"><div class="fonts"><ul>
            ...
            <div class="item"><a href="http://localhost:3000/GitExercise-GroupTT3L-11/GitExercise-GroupTT3L-11/page/clubcategory/clubcategory.php">Club categories</a>
            <div class="detail"><div class="fonts"><ul>
                <li>Sports Club</li>
                <li>Academic Club</li>
                <li>Arts Club</li>
            ...
            <div class="item"><a href="http://localhost:3000/Login-System-PHP-and-MYSQL-master/Login-System-PHP-and-MYSQL-master/index.php">Membership</a>
            <div class="detail"><div class="fonts"><ul>
                <li>Membership</li>
            </ul></div></div>
            </div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                <img src="nature3.jpg" alt="Second Image">
            </div>

            <div class="item">
                <img src="nature4.jpg" alt="Third Image">
            </div>
        </div>
