...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['qr_code'])) {
        ...
        try {
            ...
            header("Location: http://localhost:3000/GitExercise-GroupTT3L-11-/uattendance/index.php");
        ...
        echo "
            <script>
                ...
                window.location.href = 'http://localhost:3000/GitExercise-GroupTT3L-11-/uattendance/index.php';
            </script>
        ";
    }
}
