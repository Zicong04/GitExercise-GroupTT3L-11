...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['student_name'], $_POST['clubs'])) {
        ...
        try {
            $stmt = $conn->prepare("UPDATE tbl_student SET student_name = :student_name, clubs = :clubs WHERE tbl_student_id = :tbl_student_id");
            ...
            header("Location: http://localhost:3000/page/attendance/masterlist.php");
