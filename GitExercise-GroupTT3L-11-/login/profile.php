...
<body class="loggedin">
    <nav class="navtop">
        <div>
            <a href="http://localhost:3000/GitExercise-GroupTT3L-11-/userhome.php"><i class="fas fa-sign-out-alt"></i>Home</a>
            <a href="profile.php"><i class="fas fa-user-circle"></i>Profile</a>
            <a href="logout.php"><i class="fas fa-sign-out-alt"></i>Logout</a>
            <a href="http://localhost:3000/GitExercise-GroupTT3L-11-/Dailysystem.php">Daily check in</a>
        </div>
    </nav>
    <div class="content">
        <h2>Profile Page</h2>
